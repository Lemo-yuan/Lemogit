 ...
 */
@Configuration
public class LemoHandlerInterceptor implements HandlerInterceptor {
    @Override
    ...
    public WebMvcConfigurerAdapter customMvcConfigurerAdapter (){
        return new WebMvcConfigurerAdapter() {
            ...
            public void addInterceptors(InterceptorRegistry registry) {
                registry.addInterceptor(new LemoHandlerInterceptor()).addPathPatterns("/**");
                // 添加拦截器
